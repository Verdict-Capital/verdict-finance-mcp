...
export const getRatingInput = {
  ...
  identifier: z.string().min(1).describe("The entity's slug (e.g. 'aave-v3') or UUID."),
} as const;
...
export const getRatingMeta = {
  ...
  description:
    "Get the full free-tier Verdict rating for one DeFi entity (letter grade + composite score 0-100 + public metadata). Identify it by slug (e.g. 'aave-v3') or UUID. Example: get_rating({ entity_type: 'protocol', identifier: 'aave-v3' }).",
};
